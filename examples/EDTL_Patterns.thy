...
definition EDTL_final_nontemporal_or_tau_delay_true where "EDTL_final_nontemporal_or_tau_delay_true finalt trigger finale release Inv reaction s \<equiv> (always (\<lambda> r2 r1 . ((\<not> (trigger r1)) \<or> ((constrained_weak_until finalt (\<lambda> r4 r3 . ((Inv r4 r3) \<and> (\<not> (finale r3)))) (\<lambda> r4 r3 . ((release r4 r3) \<or> ((finale r3) \<and> ((reaction r4 r3) \<and> (Inv r4 r3))))) r2 r1) \<and> (constrained_until0 finalt (\<lambda> r4 r3 . True) (\<lambda> r4 r3 . ((release r4 r3) \<or> (reaction r4 r3))) r2 r1)))) s)"
...
definition EDTL_final_nontemporal_or_tau_delay_true_inv where "EDTL_final_nontemporal_or_tau_delay_true_inv finalt t1_0 t1_1 trigger finale release_1 Inv_1 reaction_1 s \<equiv> (always_inv (\<lambda> r2 r1 . ((\<not> (trigger r1)) \<or> ((constrained_weak_until_inv finalt t1_0 (\<lambda> r4 r3 . ((Inv_1 r4 r3) \<and> (\<not> (finale r3)))) (\<lambda> r4 r3 . ((release_1 r4 r3) \<or> ((finale r3) \<and> ((reaction_1 r4 r3) \<and> (Inv_1 r4 r3))))) r2 r1) \<and> (constrained_until0_inv finalt t1_1 (\<lambda> r4 r3 . True) (\<lambda> r4 r3 . ((release_1 r4 r3) \<or> (reaction_1 r4 r3))) r2 r1)))) s)"

definition EDTL_final_nontemporal_or_tau_delay_true_inv_part where "EDTL_final_nontemporal_or_tau_delay_true_inv_part finalt t1_0 t1_1 trigger finale release Inv reaction s \<equiv> (EDTL_final_nontemporal_or_tau_delay_true_inv finalt t1_0 t1_1 trigger finale (\<lambda> s s1 . (release s1)) (\<lambda> s s1 . (Inv s1)) (\<lambda> s s1 . (reaction s1)) s)"

lemma EDTL_final_nontemporal_or_tau_delay_true_inv_saving_gen: "
EDTL_final_nontemporal_or_tau_delay_true_inv finalt t1_0 t1_1 trigger finale release_1 Inv_1 reaction_1 s0 \<Longrightarrow>
consecutive s0 s \<Longrightarrow>
((True \<and> ((((always_imp s0 (\<lambda> r3 . (Inv_1 s0 r3)) (\<lambda> r3 . (Inv_1 s r3))) \<and> True) \<and> (((always_imp s0 (\<lambda> r3 . (release_1 s0 r3)) (\<lambda> r3 . (release_1 s r3))) \<and> (True \<and> ((always_imp s0 (\<lambda> r3 . (reaction_1 s0 r3)) (\<lambda> r3 . (reaction_1 s r3))) \<and> (always_imp s0 (\<lambda> r3 . (Inv_1 s0 r3)) (\<lambda> r3 . (Inv_1 s r3)))))) \<and> ((((t1_0 s0) < finalt) \<and> ((((release_1 s s) \<or> ((finale s) \<and> ((reaction_1 s s) \<and> (Inv_1 s s)))) \<and> ((t1_0 s) <= (finalt + 1))) \<or> (((t1_0 s) <= ((t1_0 s0) + 1)) \<and> ((Inv_1 s s) \<and> (\<not> (finale s)))))) \<or> (((t1_0 s0) >= finalt) \<and> ((t1_0 s) <= ((t1_0 s0) + 1)))))) \<and> (True \<and> (((always_imp s0 (\<lambda> r3 . (release_1 s0 r3)) (\<lambda> r3 . (release_1 s r3))) \<and> (always_imp s0 (\<lambda> r3 . (reaction_1 s0 r3)) (\<lambda> r3 . (reaction_1 s r3)))) \<and> (((t1_1 s0) = 0) \<or> ((((release_1 s s) \<or> (reaction_1 s s)) \<and> ((t1_1 s0) <= finalt)) \<or> (True \<and> ((t1_1 s0) < (t1_1 s))))))))) \<and> ((\<not> (trigger s)) \<or> ((((release_1 s s) \<or> ((finale s) \<and> ((reaction_1 s s) \<and> (Inv_1 s s)))) \<or> (((t1_0 s) = 0) \<and> ((Inv_1 s s) \<and> (\<not> (finale s))))) \<and> (((release_1 s s) \<or> (reaction_1 s s)) \<or> (True \<and> ((t1_1 s) > 0)))))) \<Longrightarrow>
EDTL_final_nontemporal_or_tau_delay_true_inv finalt t1_0 t1_1 trigger finale release_1 Inv_1 reaction_1 s"
...
apply(erule always_inv_saving_gen)
    ...
    apply simp
      ...
      apply(insert prems2(1,3))
        ...
        apply simp
          ...
          apply(insert prems3(1,3))
            apply(rule constrained_until0_L1)
            apply simp
              apply(erule conjE)
              subgoal premises prems16
              apply(rule conjI)
  ...
  apply(insert prems1(1,3))
    ...
    apply(rule disjI2)
      ...
      apply(insert prems21(1,3))
        apply(rule constrained_until0_L2)
        apply simp
          apply(erule disjE)
          apply(rule disjI1)
            apply(erule disjE)
...
EDTL_final_nontemporal_or_tau_delay_true_inv finalt t1_0 t1_1 trigger finale release_1 Inv_1 reaction_1 s0 \<Longrightarrow>
toEnvP s0 \<Longrightarrow>
(True \<and> ((((always_imp s0 (\<lambda> r3 . (Inv_1 s0 r3)) (\<lambda> r3 . (Inv s0 r3))) \<and> True) \<and> ((always_imp s0 (\<lambda> r3 . (release_1 s0 r3)) (\<lambda> r3 . (release s0 r3))) \<and> (True \<and> ((always_imp s0 (\<lambda> r3 . (reaction_1 s0 r3)) (\<lambda> r3 . (reaction s0 r3))) \<and> (always_imp s0 (\<lambda> r3 . (Inv_1 s0 r3)) (\<lambda> r3 . (Inv s0 r3))))))) \<and> (True \<and> (((always_imp s0 (\<lambda> r3 . (release_1 s0 r3)) (\<lambda> r3 . (release s0 r3))) \<and> (always_imp s0 (\<lambda> r3 . (reaction_1 s0 r3)) (\<lambda> r3 . (reaction s0 r3)))) \<and> ((t1_1 s0) <= finalt))))) \<Longrightarrow>
  ...
  apply simp
    ...
    apply(insert prems3(1,3))
      ...
      apply simp
        ...
        apply(insert prems4(1,3))
          apply(rule constrained_until0_L3)
          apply simp
            apply(erule conjE)
            subgoal premises prems10
            apply(rule conjI)
...
EDTL_final_nontemporal_or_tau_delay_true_inv_part finalt t1_0 t1_1 trigger finale release Inv reaction s0 \<Longrightarrow>
consecutive s0 s \<Longrightarrow>
((((((t1_0 s0) < finalt) \<and> ((((release s) \<or> ((finale s) \<and> ((reaction s) \<and> (Inv s)))) \<and> ((t1_0 s) <= (finalt + 1))) \<or> (((t1_0 s) <= ((t1_0 s0) + 1)) \<and> ((Inv s) \<and> (\<not> (finale s)))))) \<or> (((t1_0 s0) >= finalt) \<and> ((t1_0 s) <= ((t1_0 s0) + 1)))) \<and> (((t1_1 s0) = 0) \<or> ((((release s) \<or> (reaction s)) \<and> ((t1_1 s0) <= finalt)) \<or> ((t1_1 s0) < (t1_1 s))))) \<and> ((\<not> (trigger s)) \<or> ((((release s) \<or> ((finale s) \<and> ((reaction s) \<and> (Inv s)))) \<or> (((t1_0 s) = 0) \<and> ((Inv s) \<and> (\<not> (finale s))))) \<and> (((release s) \<or> (reaction s)) \<or> ((t1_1 s) > 0))))) \<Longrightarrow>
EDTL_final_nontemporal_or_tau_delay_true_inv_part finalt t1_0 t1_1 trigger finale release Inv reaction s"
...
EDTL_final_nontemporal_or_tau_delay_true_inv_part finalt t1_0 t1_1 trigger finale release Inv reaction s \<Longrightarrow>
toEnvP s \<Longrightarrow>
((t1_1 s) <= finalt) \<Longrightarrow>
...
lemmas EDTL_final_nontemporal_or_tau_delay_true_used_patterns = EDTL_final_nontemporal_or_tau_delay_true_def always_used_patterns constrained_weak_until_def constrained_until0_def 

lemmas EDTL_final_nontemporal_or_tau_delay_true_inv_used_patterns = EDTL_final_nontemporal_or_tau_delay_true_inv_def always_inv_used_patterns constrained_weak_until_inv_def constrained_until0_inv_def 
...
definition EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv where "EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv finalt b_0 t1_0 t1_1 trigger finale release_1 Inv_1 reaction_1 s \<equiv> ((always_inv (\<lambda> r2 r1 . ((weak_previous (\<lambda> r4 r3 . (\<not> (trigger r3))) r2 r1) \<or> ((constrained_weak_until_inv finalt t1_0 (\<lambda> r4 r3 . ((Inv_1 r4 r3) \<and> (\<not> (finale r3)))) (\<lambda> r4 r3 . ((release_1 r4 r3) \<or> ((finale r3) \<and> ((reaction_1 r4 r3) \<and> (Inv_1 r4 r3))))) r2 r1) \<and> (constrained_until0_inv finalt t1_1 (\<lambda> r4 r3 . True) (\<lambda> r4 r3 . ((release_1 r4 r3) \<or> (reaction_1 r4 r3))) r2 r1)))) s) \<and> (previous_inv b_0 (\<lambda> r4 r3 . (\<not> (trigger r3))) s))"

definition EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv_part where "EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv_part finalt b_0 t1_0 t1_1 trigger finale release Inv reaction s \<equiv> (EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv finalt b_0 t1_0 t1_1 trigger finale (\<lambda> s s1 . (release s1)) (\<lambda> s s1 . (Inv s1)) (\<lambda> s s1 . (reaction s1)) s)"

lemma EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv_saving_gen: "
EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv finalt b_0 t1_0 t1_1 trigger finale release_1 Inv_1 reaction_1 s0 \<Longrightarrow>
consecutive s0 s \<Longrightarrow>
(((True \<and> ((((always_imp s0 (\<lambda> r3 . (Inv_1 s0 r3)) (\<lambda> r3 . (Inv_1 s r3))) \<and> True) \<and> (((always_imp s0 (\<lambda> r3 . (release_1 s0 r3)) (\<lambda> r3 . (release_1 s r3))) \<and> (True \<and> ((always_imp s0 (\<lambda> r3 . (reaction_1 s0 r3)) (\<lambda> r3 . (reaction_1 s r3))) \<and> (always_imp s0 (\<lambda> r3 . (Inv_1 s0 r3)) (\<lambda> r3 . (Inv_1 s r3)))))) \<and> ((((t1_0 s0) < finalt) \<and> ((((release_1 s s) \<or> ((finale s) \<and> ((reaction_1 s s) \<and> (Inv_1 s s)))) \<and> ((t1_0 s) <= (finalt + 1))) \<or> (((t1_0 s) <= ((t1_0 s0) + 1)) \<and> ((Inv_1 s s) \<and> (\<not> (finale s)))))) \<or> (((t1_0 s0) >= finalt) \<and> ((t1_0 s) <= ((t1_0 s0) + 1)))))) \<and> (True \<and> (((always_imp s0 (\<lambda> r3 . (release_1 s0 r3)) (\<lambda> r3 . (release_1 s r3))) \<and> (always_imp s0 (\<lambda> r3 . (reaction_1 s0 r3)) (\<lambda> r3 . (reaction_1 s r3)))) \<and> (((t1_1 s0) = 0) \<or> ((((release_1 s s) \<or> (reaction_1 s s)) \<and> ((t1_1 s0) <= finalt)) \<or> (True \<and> ((t1_1 s0) < (t1_1 s))))))))) \<and> (((b_0 s0) \<and> True) \<or> ((((release_1 s s) \<or> ((finale s) \<and> ((reaction_1 s s) \<and> (Inv_1 s s)))) \<or> (((t1_0 s) = 0) \<and> ((Inv_1 s s) \<and> (\<not> (finale s))))) \<and> (((release_1 s s) \<or> (reaction_1 s s)) \<or> (True \<and> ((t1_1 s) > 0)))))) \<and> ((b_0 s) --> (\<not> (trigger s)))) \<Longrightarrow>
EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv finalt b_0 t1_0 t1_1 trigger finale release_1 Inv_1 reaction_1 s"
...
EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv_part finalt b_0 t1_0 t1_1 trigger finale release Inv reaction s0 \<Longrightarrow>
consecutive s0 s \<Longrightarrow>
(((((((t1_0 s0) < finalt) \<and> ((((release s) \<or> ((finale s) \<and> ((reaction s) \<and> (Inv s)))) \<and> ((t1_0 s) <= (finalt + 1))) \<or> (((t1_0 s) <= ((t1_0 s0) + 1)) \<and> ((Inv s) \<and> (\<not> (finale s)))))) \<or> (((t1_0 s0) >= finalt) \<and> ((t1_0 s) <= ((t1_0 s0) + 1)))) \<and> (((t1_1 s0) = 0) \<or> ((((release s) \<or> (reaction s)) \<and> ((t1_1 s0) <= finalt)) \<or> ((t1_1 s0) < (t1_1 s))))) \<and> ((b_0 s0) \<or> ((((release s) \<or> ((finale s) \<and> ((reaction s) \<and> (Inv s)))) \<or> (((t1_0 s) = 0) \<and> ((Inv s) \<and> (\<not> (finale s))))) \<and> (((release s) \<or> (reaction s)) \<or> ((t1_1 s) > 0))))) \<and> ((b_0 s) --> (\<not> (trigger s)))) \<Longrightarrow>
EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv_part finalt b_0 t1_0 t1_1 trigger finale release Inv reaction s"
...
EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv_part finalt b_0 t1_0 t1_1 trigger finale release Inv reaction s \<Longrightarrow>
toEnvP s \<Longrightarrow>
((t1_1 s) <= finalt) \<Longrightarrow>
...
lemmas EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_used_patterns = EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_def always_used_patterns weak_previous_def constrained_weak_until_def constrained_until0_def 

lemmas EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv_used_patterns = EDTL_trigger_prev_final_nontemporal_or_tau_delay_true_inv_def always_inv_used_patterns weak_previous_def constrained_weak_until_inv_def constrained_until0_inv_def previous_inv_def 
