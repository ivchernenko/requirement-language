...
unfolding VC1_def R5_extended_inv_def Einv5_def R5_def P1_2_inv_part_used_patterns P1_2_part_used_patterns commonExtraInv_def
by auto

theorem extendedInv2: "VC2 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv3: "VC3 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv4: "VC4 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv5: "VC5 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv6: "VC6 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv7: "VC7 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv8: "VC8 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv9: "VC9 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv10: "VC10 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv11: "VC11 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv12: "VC12 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv13: "VC13 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv14: "VC14 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv15: "VC15 R5_extended_inv env s0  user'value pressure'value"
...
theorem extendedInv16: "VC16 R5_extended_inv env s0  user'value pressure'value"
