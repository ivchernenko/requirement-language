...
lemma weak_until_rule[patternintro]: "consecutive s0 s \<Longrightarrow>
...
lemma weak_until_one_point[patternintro]: "toEnvP s \<Longrightarrow> A2 s s \<or> w s \<and> A1 s s \<Longrightarrow> weak_until_inv w A1 A2  s s"
