...
unfolding VC1_def R4_extended_inv_def Einv4_def R4_def P3_2_inv_part_used_patterns P3_2_part_used_patterns commonExtraInv_def
by auto

theorem extendedInv2: "VC2 R4_extended_inv env s0  requestButton'value"
unfolding VC2_def R4_extended_inv_def R4_def  apply(rule impI)
  ...
  apply(erule conjE)+
  apply(auto simp add: P3_2einv_imp_req)
  done

theorem extendedInv3: "VC3 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv4: "VC4 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv5: "VC5 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv6: "VC6 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv7: "VC7 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv8: "VC8 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv9: "VC9 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv10: "VC10 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv11: "VC11 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv12: "VC12 R4_extended_inv env s0  requestButton'value"
...
theorem extendedInv13: "VC13 R4_extended_inv env s0  requestButton'value"
