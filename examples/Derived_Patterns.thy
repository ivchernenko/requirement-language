...
unfolding always2_inv_part_def always2_part_def
...
definition P1_1 where "P1_1 t A1 A2 A3 s \<equiv> (always (\<lambda> r2 r1 . ((\<not> (A1 r1)) \<or> (constrained_until0 t A2 A3 r2 r1))) s)"

definition P1_1_part where "P1_1_part t A1 A2 A3 s \<equiv> (P1_1 t A1 (\<lambda> s s1 . (A2 s1)) (\<lambda> s s1 . (A3 s1)) s)"

definition P1_1_inv where "P1_1_inv t t1_0 A1 A2_1 A3_1 s \<equiv> (always_inv (\<lambda> r2 r1 . ((\<not> (A1 r1)) \<or> (constrained_until0_inv t t1_0 A2_1 A3_1 r2 r1))) s)"
...
unfolding P1_1_inv_def P1_1_def
apply(erule always_einv_imp_req_gen)
apply simp
  apply(rule always_disj_rule)
  apply simp
...
unfolding P1_1_inv_part_def P1_1_part_def
...
lemmas P1_1_used_patterns = P1_1_def always_used_patterns constrained_until0_def 

lemmas P1_1_inv_used_patterns = P1_1_inv_def always_inv_used_patterns constrained_until0_inv_def 
...
definition P1_2 where "P1_2 t A11 A12 A2 A3 s \<equiv> (always (\<lambda> r2 r1 . ((weak_previous (\<lambda> r4 r3 . (\<not> (A11 r3))) r2 r1) \<or> ((\<not> (A12 r1)) \<or> (constrained_until0 t A2 A3 r2 r1)))) s)"

definition P1_2_part where "P1_2_part t A11 A12 A2 A3 s \<equiv> (P1_2 t A11 A12 (\<lambda> s s1 . (A2 s1)) (\<lambda> s s1 . (A3 s1)) s)"

definition P1_2_inv where "P1_2_inv t b_0 t1_0 A11 A12 A2_1 A3_1 s \<equiv> ((always_inv (\<lambda> r2 r1 . ((weak_previous (\<lambda> r4 r3 . (\<not> (A11 r3))) r2 r1) \<or> ((\<not> (A12 r1)) \<or> (constrained_until0_inv t t1_0 A2_1 A3_1 r2 r1)))) s) \<and> (previous_inv b_0 (\<lambda> r4 r3 . (\<not> (A11 r3))) s))"
...
unfolding P1_2_inv_part_def P1_2_part_def
...
lemmas P1_2_used_patterns = P1_2_def always_used_patterns weak_previous_def constrained_until0_def 

lemmas P1_2_inv_used_patterns = P1_2_inv_def always_inv_used_patterns weak_previous_def constrained_until0_inv_def previous_inv_def 
...
apply(erule always_inv_saving_gen)
  ...
  apply(insert prems1(1,2))[1]
    ...
    apply simp
      ...
      apply(insert prems2(1,2))[1]
        apply(rule always_imp_refl)
      apply(insert prems2(1,3))
        apply(rule constrained_always_L1)
        apply simp
          apply(erule disjE)
          apply(rule disjI1)
            apply simp
  ...
  apply(insert prems1(1,3))
    ...
    apply(rule disjI1)
      apply simp
    apply(rule disjI2)
      apply(rule constrained_always_L2)
      apply simp
        apply(erule disjE)
        apply(rule disjI1)
          apply simp
...
unfolding P2_1_inv_def P2_1_def
apply(erule always_einv_imp_req_gen)
apply simp
  apply(rule always_disj_rule)
  apply simp
    ...
    apply(insert prems3(1,2))[1]
      apply(rule always_imp_refl)
    apply(insert prems3(1,3))
      apply(rule constrained_always_L3)
      apply simp
        apply simp
    done
done
...
unfolding P2_1_inv_part_def P2_1_part_def
...
unfolding P2_2_inv_def P2_2_def
subgoal premises prems1
apply(insert prems1(1,2))
apply(erule conjE)
subgoal premises prems2
...
unfolding P2_2_inv_part_def P2_2_part_def
...
unfolding P3_1_inv_def P3_1_def
apply(erule always_einv_imp_req_gen)
apply simp
  apply(rule always_disj_rule)
  apply simp
...
unfolding P3_1_inv_part_def P3_1_part_def
...
unfolding P3_2_inv_def P3_2_def
subgoal premises prems1
apply(insert prems1(1,2))
apply(erule conjE)
subgoal premises prems2
...
unfolding P3_2_inv_part_def P3_2_part_def
...
unfolding P3_3_inv_def P3_3_def
subgoal premises prems1
apply(insert prems1(1,2))
apply(erule conjE)
subgoal premises prems2
...
unfolding P3_3_inv_part_def P3_3_part_def
...
toEnvP s0 \<Longrightarrow>
((True \<and> True) \<and> ((always_imp s0 (A2_1 s0) (A2 s0)) \<and> (always_imp s0 (A3_1 s0) (A3 s0)))) \<Longrightarrow>
P3_4 A11 A12 A2 A3 s0"

unfolding P3_4_inv_def P3_4_def
subgoal premises prems1
apply(insert prems1(1,2))
...
unfolding P3_4_inv_part_def P3_4_part_def
...
unfolding P4_1_inv_def P4_1_def
apply(erule always_einv_imp_req_gen)
apply simp
  apply(rule always_disj_rule)
  apply simp
...
unfolding P4_1_inv_part_def P4_1_part_def
...
unfolding P4_2_inv_def P4_2_def
subgoal premises prems1
apply(insert prems1(1,2))
apply(erule conjE)
subgoal premises prems2
...
unfolding P4_2_inv_part_def P4_2_part_def
...
consecutive s0 s \<Longrightarrow>
(((((True \<and> True) \<and> (True \<and> (always_imp s0 (\<lambda> r1 . (A4_1 s0 r1)) (\<lambda> r1 . (A4_1 s r1))))) \<and> (((b_1 s0) \<and> (True \<and> True)) \<or> ((\<not> (A3 s)) \<or> (A4_1 s s)))) \<and> ((b_1 s) --> (((t > 0) \<or> (\<not> (A1 s))) \<and> ((\<not> (A2 s)) \<or> ((b_0 s0) \<and> (True \<and> (True \<and> (((t1_0 s0) = 0) \<or> ((t1_0 s0) < t))))))))) \<and> ((b_0 s) --> ((((t1_0 s) > 0) \<or> (\<not> (A1 s))) \<and> ((\<not> (A2 s)) \<or> ((b_0 s0) \<and> (True \<and> (True \<and> (((t1_0 s0) = 0) \<or> ((t1_0 s0) < (t1_0 s)))))))))) \<Longrightarrow>
...
unfolding P6_1_inv_def P6_1_def
subgoal premises prems1
apply(insert prems1(1,2))
apply(simp only: conj_assoc)
apply(erule conjE)
...
consecutive s0 s \<Longrightarrow>
((((b_1 s0) \<or> ((\<not> (A3 s)) \<or> (A4 s))) \<and> ((b_1 s) --> (((t > 0) \<or> (\<not> (A1 s))) \<and> ((\<not> (A2 s)) \<or> ((b_0 s0) \<and> (((t1_0 s0) = 0) \<or> ((t1_0 s0) < t))))))) \<and> ((b_0 s) --> ((((t1_0 s) > 0) \<or> (\<not> (A1 s))) \<and> ((\<not> (A2 s)) \<or> ((b_0 s0) \<and> (((t1_0 s0) = 0) \<or> ((t1_0 s0) < (t1_0 s)))))))) \<Longrightarrow>
...
consecutive s0 s \<Longrightarrow>
(((((True \<and> True) \<and> (True \<and> ((always_imp s0 (A4_1 s0) (A4_1 s)) \<and> ((always_imp s0 (A5_1 s0) (A5_1 s)) \<and> ((\<not> (w_0 s0)) \<or> ((A5_1 s s) \<or> ((w_0 s) \<and> (A4_1 s s)))))))) \<and> (((b_1 s0) \<and> (True \<and> True)) \<or> ((\<not> (A3 s)) \<or> ((A5_1 s s) \<or> ((w_0 s) \<and> (A4_1 s s)))))) \<and> ((b_1 s) --> (((t > 0) \<or> (\<not> (A1 s))) \<and> ((\<not> (A2 s)) \<or> ((b_0 s0) \<and> (True \<and> (True \<and> (((t1_0 s0) = 0) \<or> ((t1_0 s0) < t))))))))) \<and> ((b_0 s) --> ((((t1_0 s) > 0) \<or> (\<not> (A1 s))) \<and> ((\<not> (A2 s)) \<or> ((b_0 s0) \<and> (True \<and> (True \<and> (((t1_0 s0) = 0) \<or> ((t1_0 s0) < (t1_0 s)))))))))) \<Longrightarrow>
...
unfolding P6_2_inv_def P6_2_def
subgoal premises prems1
apply(insert prems1(1,2))
apply(simp only: conj_assoc)
apply(erule conjE)
...
consecutive s0 s \<Longrightarrow>
(((((\<not> (w_0 s0)) \<or> ((A5 s) \<or> ((w_0 s) \<and> (A4 s)))) \<and> ((b_1 s0) \<or> ((\<not> (A3 s)) \<or> ((A5 s) \<or> ((w_0 s) \<and> (A4 s)))))) \<and> ((b_1 s) --> (((t > 0) \<or> (\<not> (A1 s))) \<and> ((\<not> (A2 s)) \<or> ((b_0 s0) \<and> (((t1_0 s0) = 0) \<or> ((t1_0 s0) < t))))))) \<and> ((b_0 s) --> ((((t1_0 s) > 0) \<or> (\<not> (A1 s))) \<and> ((\<not> (A2 s)) \<or> ((b_0 s0) \<and> (((t1_0 s0) = 0) \<or> ((t1_0 s0) < (t1_0 s)))))))) \<Longrightarrow>
...
P_constrained_always_after_max_delay t1 t2 A11 A12 A2 A3 s0"

unfolding P_constrained_always_after_max_delay_inv_def P_constrained_always_after_max_delay_def
...
P_constrained_always_after_max_delay_inv_part t1 t2 t1_0 b_0_0 t1_0_0 A11 A12 A2 A3 s"

unfolding P_constrained_always_after_max_delay_inv_part_def P_constrained_always_after_max_delay_part_def
...
P_constrained_always_after_max_delay_part t1 t2 A11 A12 A2 A3 s"
