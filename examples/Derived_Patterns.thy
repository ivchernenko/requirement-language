...
always2_inv_part b_0 A11 A12 A2 s"
  unfolding always2_inv_part_def
  apply(auto simp add: always2_inv_saving_gen always_imp_refl)
  done
...
always2_part A11 A12 A2 s"
  ...
  apply(auto simp add: always2einv_imp_req_gen always_imp_refl)
  done
...
P1_1_part t A1 A2 A3 s"
  ...
  apply(auto simp add: P1_1einv_imp_req_gen always_imp_refl)
  done
...
P3_2_inv_part b_0 w_0 A11 A12 A2 A3 s"
  unfolding P3_2_inv_part_def
  by(simp add: P3_2_inv_saving_gen always_imp_refl)
...
P3_2_part A11 A12 A2 A3 s"
  ...
  by(simp add: P3_2einv_imp_req_gen always_imp_refl)
...
P3_3_inv_part b_0 w_0 A1 A2 A3 s"
  unfolding P3_3_inv_part_def
  by(simp add: P3_3_inv_saving_gen always_imp_refl)
...
P3_3_part A1 A2 A3 s"
  ...
  by(simp add: P3_3einv_imp_req_gen always_imp_refl)
...
P3_4_inv_part b_0 b_1 w_0 A11 A12 A2 A3 s"
  unfolding P3_4_inv_part_def
  by(simp add: P3_4_inv_saving_gen always_imp_refl)
...
P3_4_part A11 A12 A2 A3 s"
  ...
  by(simp add: P3_4einv_imp_req_gen always_imp_refl)
...
P4_1_inv_part t t1_0 A1 A2 A3 s"
  unfolding P4_1_inv_part_def
  by(simp add: P4_1_inv_saving_gen always_imp_refl)
...
P4_1_part t A1 A2 A3 s"
  ...
  by(simp add: P4_1einv_imp_req_gen always_imp_refl)
...
P4_2_inv_part t b_0 t1_0 A11 A12 A2 A3 s"
  unfolding P4_2_inv_part_def
  by(simp add: P4_2_inv_saving_gen always_imp_refl)
...
P4_2_part t A11 A12 A2 A3 s"
  ...
  by(simp add: P4_2einv_imp_req_gen always_imp_refl)
