...
(getPstate s p_StopEngine' = STOP \<longrightarrow> getPstate s p_EngineController' \<noteq> STOP) \<and>
...
getPstate s p_EngineController' \<in> 
  {p_EngineController's_turnedOff', p_EngineController's_turningOn', p_EngineController's_turnedOn', STOP} \<and>
getPstate s p_CoolingAgentController' \<in> {p_CoolingAgentController's_normal', p_CoolingAgentController's_lack', STOP} \<and>
getPstate s p_StopEngine' \<in> {STOP, p_StopEngine's_stopEngine'} \<and>
