...
abbreviation p_Cooling's_ctrl' :: pstate where "p_Cooling's_ctrl' \<equiv> (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc 0))))))))"
abbreviation p_CoolingAgentController's_normal' :: pstate where "p_CoolingAgentController's_normal' \<equiv> (Suc (Suc (Suc (Suc (Suc 0)))))"
abbreviation p_CoolingAgentController's_lack' :: pstate where "p_CoolingAgentController's_lack' \<equiv> (Suc (Suc (Suc (Suc (Suc (Suc 0))))))"
abbreviation p_Sound's_sound' :: pstate where "p_Sound's_sound' \<equiv> (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc 0)))))))))"
...
abbreviation p_StopEngine's_stopEngine' :: pstate where "p_StopEngine's_stopEngine' \<equiv> (Suc (Suc (Suc (Suc (Suc (Suc (Suc 0)))))))"
