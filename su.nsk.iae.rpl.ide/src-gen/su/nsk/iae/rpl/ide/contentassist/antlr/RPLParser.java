...
public class RPLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RPLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getOuterRequirementPatternInstanceAccess().getGroup_3_3(), "rule__OuterRequirementPatternInstance__Group_3_3__0");
			...
			builder.put(grammarAccess.getBasicRequirementPatternInstanceAccess().getGroup_3_4(), "rule__BasicRequirementPatternInstance__Group_3_4__0");
			...
			builder.put(grammarAccess.getBasicRequirementPatternInstanceAccess().getGroup_5(), "rule__BasicRequirementPatternInstance__Group_5__0");
			builder.put(grammarAccess.getBasicRequirementPatternInstanceAccess().getGroup_5_3(), "rule__BasicRequirementPatternInstance__Group_5_3__0");
			...
			builder.put(grammarAccess.getDerivedExtraInvariantPatternAccess().getGroup_9(), "rule__DerivedExtraInvariantPattern__Group_9__0");
			...
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getSimpleFmParamAssignment_5_4_1(), "rule__DerivedRequirementPattern__SimpleFmParamAssignment_5_4_1");
			...
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getFileAssignment_8_1_1(), "rule__DerivedRequirementPattern__FileAssignment_8_1_1");
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getExtraInvPatternAssignment_8_1_3(), "rule__DerivedRequirementPattern__ExtraInvPatternAssignment_8_1_3");
			...
			builder.put(grammarAccess.getOuterRequirementPatternInstanceAccess().getFmParamsAssignment_3_2(), "rule__OuterRequirementPatternInstance__FmParamsAssignment_3_2");
			builder.put(grammarAccess.getOuterRequirementPatternInstanceAccess().getFmParamsAssignment_3_3_1(), "rule__OuterRequirementPatternInstance__FmParamsAssignment_3_3_1");
			builder.put(grammarAccess.getOuterRequirementPatternInstanceAccess().getFinStateAssignment_4_2(), "rule__OuterRequirementPatternInstance__FinStateAssignment_4_2");
			builder.put(grammarAccess.getOuterRequirementPatternInstanceAccess().getCurStateAssignment_4_3_2(), "rule__OuterRequirementPatternInstance__CurStateAssignment_4_3_2");
			...
			builder.put(grammarAccess.getBasicRequirementPatternInstanceAccess().getSimpleFmParamsAssignment_3_3(), "rule__BasicRequirementPatternInstance__SimpleFmParamsAssignment_3_3");
			builder.put(grammarAccess.getBasicRequirementPatternInstanceAccess().getSimpleFmParamsAssignment_3_4_1(), "rule__BasicRequirementPatternInstance__SimpleFmParamsAssignment_3_4_1");
			builder.put(grammarAccess.getBasicRequirementPatternInstanceAccess().getFmParamsAssignment_4_2(), "rule__BasicRequirementPatternInstance__FmParamsAssignment_4_2");
			builder.put(grammarAccess.getBasicRequirementPatternInstanceAccess().getFmParamsAssignment_4_3_1(), "rule__BasicRequirementPatternInstance__FmParamsAssignment_4_3_1");
			builder.put(grammarAccess.getBasicRequirementPatternInstanceAccess().getFinStateAssignment_5_2(), "rule__BasicRequirementPatternInstance__FinStateAssignment_5_2");
			builder.put(grammarAccess.getBasicRequirementPatternInstanceAccess().getCurStateAssignment_5_3_2(), "rule__BasicRequirementPatternInstance__CurStateAssignment_5_3_2");
			...
			builder.put(grammarAccess.getDerivedExtraInvariantPatternAccess().getSimpleFmParamAssignment_6_4_1(), "rule__DerivedExtraInvariantPattern__SimpleFmParamAssignment_6_4_1");
			...
			builder.put(grammarAccess.getDerivedExtraInvariantPatternAccess().getFileAssignment_9_1(), "rule__DerivedExtraInvariantPattern__FileAssignment_9_1");
			builder.put(grammarAccess.getDerivedExtraInvariantPatternAccess().getLemmasAssignment_10(), "rule__DerivedExtraInvariantPattern__LemmasAssignment_10");
