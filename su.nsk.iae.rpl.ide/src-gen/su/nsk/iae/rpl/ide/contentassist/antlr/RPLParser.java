...
public class RPLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RPLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRequirementPatternAccess().getAlternatives(), "rule__RequirementPattern__Alternatives");
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getAlternatives_7(), "rule__DerivedRequirementPattern__Alternatives_7");
			...
			builder.put(grammarAccess.getExtraInvariantAccess().getAlternatives_3(), "rule__ExtraInvariant__Alternatives_3");
			...
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getGroup_5_3(), "rule__DerivedRequirementPattern__Group_5_3__0");
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getGroup_7_0(), "rule__DerivedRequirementPattern__Group_7_0__0");
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getGroup_7_1(), "rule__DerivedRequirementPattern__Group_7_1__0");
			...
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getGroup(), "rule__RequirementPatternInstance__Group__0");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getGroup_2(), "rule__RequirementPatternInstance__Group_2__0");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getGroup_2_3(), "rule__RequirementPatternInstance__Group_2_3__0");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getGroup_3(), "rule__RequirementPatternInstance__Group_3__0");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getGroup_3_3(), "rule__RequirementPatternInstance__Group_3_3__0");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getGroup_4(), "rule__RequirementPatternInstance__Group_4__0");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getGroup_4_3(), "rule__RequirementPatternInstance__Group_4_3__0");
			...
			builder.put(grammarAccess.getFutureExtraInvariantPatternAccess().getGroup_8(), "rule__FutureExtraInvariantPattern__Group_8__0");
			...
			builder.put(grammarAccess.getPastExtraInvariantPatternAccess().getGroup_8(), "rule__PastExtraInvariantPattern__Group_8__0");
			...
			builder.put(grammarAccess.getDerivedExtraInvariantPatternAccess().getGroup_6_3(), "rule__DerivedExtraInvariantPattern__Group_6_3__0");
			builder.put(grammarAccess.getDerivedExtraInvariantPatternAccess().getGroup_8(), "rule__DerivedExtraInvariantPattern__Group_8__0");
			...
			builder.put(grammarAccess.getRequirementAccess().getGroup_2_0_3(), "rule__Requirement__Group_2_0_3__0");
			builder.put(grammarAccess.getRequirementAccess().getGroup_2_0_3_3(), "rule__Requirement__Group_2_0_3_3__0");
			builder.put(grammarAccess.getRequirementAccess().getGroup_2_0_4(), "rule__Requirement__Group_2_0_4__0");
			builder.put(grammarAccess.getRequirementAccess().getGroup_2_0_4_3(), "rule__Requirement__Group_2_0_4_3__0");
			...
			builder.put(grammarAccess.getExtraInvariantAccess().getGroup_3_0(), "rule__ExtraInvariant__Group_3_0__0");
			builder.put(grammarAccess.getExtraInvariantAccess().getGroup_3_1(), "rule__ExtraInvariant__Group_3_1__0");
			...
			builder.put(grammarAccess.getLemmaAccess().getGroup_2_5(), "rule__Lemma__Group_2_5__0");
			builder.put(grammarAccess.getLemmaAccess().getGroup_3(), "rule__Lemma__Group_3__0");
			builder.put(grammarAccess.getLemmaAccess().getGroup_3_4(), "rule__Lemma__Group_3_4__0");
			...
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getFmParamsAssignment_5_2(), "rule__DerivedRequirementPattern__FmParamsAssignment_5_2");
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getFmParamsAssignment_5_3_1(), "rule__DerivedRequirementPattern__FmParamsAssignment_5_3_1");
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getDefinitionAssignment_7_0_1(), "rule__DerivedRequirementPattern__DefinitionAssignment_7_0_1");
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getFileAssignment_7_1_1(), "rule__DerivedRequirementPattern__FileAssignment_7_1_1");
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getExtraInvPatternAssignment_7_1_3(), "rule__DerivedRequirementPattern__ExtraInvPatternAssignment_7_1_3");
			builder.put(grammarAccess.getDerivedRequirementPatternAccess().getLemmasAssignment_8(), "rule__DerivedRequirementPattern__LemmasAssignment_8");
			...
			builder.put(grammarAccess.getFormulaParameterAccess().getNameAssignment(), "rule__FormulaParameter__NameAssignment");
			...
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getPatternAssignment_0(), "rule__RequirementPatternInstance__PatternAssignment_0");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getCParamsAssignment_2_2(), "rule__RequirementPatternInstance__CParamsAssignment_2_2");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getCParamsAssignment_2_3_1(), "rule__RequirementPatternInstance__CParamsAssignment_2_3_1");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getFmParamsAssignment_3_2(), "rule__RequirementPatternInstance__FmParamsAssignment_3_2");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getFmParamsAssignment_3_3_1(), "rule__RequirementPatternInstance__FmParamsAssignment_3_3_1");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getFinStateAssignment_4_2(), "rule__RequirementPatternInstance__FinStateAssignment_4_2");
			builder.put(grammarAccess.getRequirementPatternInstanceAccess().getCurStateAssignment_4_3_2(), "rule__RequirementPatternInstance__CurStateAssignment_4_3_2");
			...
			builder.put(grammarAccess.getFutureRequirementPatternAccess().getFileAssignment_8(), "rule__FutureRequirementPattern__FileAssignment_8");
			builder.put(grammarAccess.getFutureRequirementPatternAccess().getExtraInvPatternAssignment_10(), "rule__FutureRequirementPattern__ExtraInvPatternAssignment_10");
			builder.put(grammarAccess.getFutureRequirementPatternAccess().getLessasAssignment_11(), "rule__FutureRequirementPattern__LessasAssignment_11");
			...
			builder.put(grammarAccess.getPastRequirementPatternAccess().getFileAssignment_8(), "rule__PastRequirementPattern__FileAssignment_8");
			builder.put(grammarAccess.getPastRequirementPatternAccess().getExtraInvPatternAssignment_10(), "rule__PastRequirementPattern__ExtraInvPatternAssignment_10");
			builder.put(grammarAccess.getPastRequirementPatternAccess().getLemmasAssignment_11(), "rule__PastRequirementPattern__LemmasAssignment_11");
			...
			builder.put(grammarAccess.getFutureExtraInvariantPatternAccess().getFileAssignment_8_1(), "rule__FutureExtraInvariantPattern__FileAssignment_8_1");
			builder.put(grammarAccess.getFutureExtraInvariantPatternAccess().getLemmasAssignment_9(), "rule__FutureExtraInvariantPattern__LemmasAssignment_9");
			...
			builder.put(grammarAccess.getPastExtraInvariantPatternAccess().getFileAssignment_8_1(), "rule__PastExtraInvariantPattern__FileAssignment_8_1");
			builder.put(grammarAccess.getPastExtraInvariantPatternAccess().getLemmasAssignment_9(), "rule__PastExtraInvariantPattern__LemmasAssignment_9");
			...
			builder.put(grammarAccess.getDerivedExtraInvariantPatternAccess().getFmParamsAssignment_6_2(), "rule__DerivedExtraInvariantPattern__FmParamsAssignment_6_2");
			builder.put(grammarAccess.getDerivedExtraInvariantPatternAccess().getFmParamsAssignment_6_3_1(), "rule__DerivedExtraInvariantPattern__FmParamsAssignment_6_3_1");
			builder.put(grammarAccess.getDerivedExtraInvariantPatternAccess().getFileAssignment_8_1(), "rule__DerivedExtraInvariantPattern__FileAssignment_8_1");
			...
			builder.put(grammarAccess.getRequirementAccess().getPatternAssignment_2_0_1(), "rule__Requirement__PatternAssignment_2_0_1");
			builder.put(grammarAccess.getRequirementAccess().getCParamsAssignment_2_0_3_2(), "rule__Requirement__CParamsAssignment_2_0_3_2");
			builder.put(grammarAccess.getRequirementAccess().getCParamsAssignment_2_0_3_3_1(), "rule__Requirement__CParamsAssignment_2_0_3_3_1");
			builder.put(grammarAccess.getRequirementAccess().getFmParamsAssignment_2_0_4_2(), "rule__Requirement__FmParamsAssignment_2_0_4_2");
			builder.put(grammarAccess.getRequirementAccess().getFmParamsAssignment_2_0_4_3_1(), "rule__Requirement__FmParamsAssignment_2_0_4_3_1");
			builder.put(grammarAccess.getRequirementAccess().getPatternAssignment_2_1_1(), "rule__Requirement__PatternAssignment_2_1_1");
			builder.put(grammarAccess.getRequirementAccess().getExtraInAssignment_2_1_3(), "rule__Requirement__ExtraInAssignment_2_1_3");
			builder.put(grammarAccess.getExtraInvariantAccess().getNameAssignment_2(), "rule__ExtraInvariant__NameAssignment_2");
			builder.put(grammarAccess.getExtraInvariantAccess().getPatternAssignment_3_0_1(), "rule__ExtraInvariant__PatternAssignment_3_0_1");
			builder.put(grammarAccess.getExtraInvariantAccess().getReqNameAssignment_3_0_3(), "rule__ExtraInvariant__ReqNameAssignment_3_0_3");
			builder.put(grammarAccess.getExtraInvariantAccess().getReqAssignment_3_1_1(), "rule__ExtraInvariant__ReqAssignment_3_1_1");
			...
			builder.put(grammarAccess.getLemmaAccess().getIfmVarsAssignment_2_5_1(), "rule__Lemma__IfmVarsAssignment_2_5_1");
			builder.put(grammarAccess.getLemmaAccess().getRfmVarsAssignment_3_3(), "rule__Lemma__RfmVarsAssignment_3_3");
			builder.put(grammarAccess.getLemmaAccess().getRfmVarsAssignment_3_4_1(), "rule__Lemma__RfmVarsAssignment_3_4_1");
			builder.put(grammarAccess.getLemmaAccess().getInitStateAssignment_4_3(), "rule__Lemma__InitStateAssignment_4_3");
			builder.put(grammarAccess.getLemmaAccess().getFinalStateAssignment_5_3(), "rule__Lemma__FinalStateAssignment_5_3");
			builder.put(grammarAccess.getLemmaAccess().getPremAssignment_6_1(), "rule__Lemma__PremAssignment_6_1");
